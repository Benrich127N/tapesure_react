...
const Topbar = () => {
  ...
  type="text"
  placeholder="Search..."
  className="bg-slate-700 text-white placeholder-gray-300 border border-purple-700 rounded-lg px-4 py-2 w-1/3 focus:outline-none focus:ring-2 focus:ring-purple-500"
/>
