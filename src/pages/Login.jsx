    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-indigo-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl sm:rounded-3xl mb-4 shadow-lg shadow-indigo-500/50 transform hover:scale-110 transition-transform duration-300">
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800/50 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8">
          ...
          {/* Form */}
          <form onSubmit={mode === "login" ? handleEmailLogin : handleEmailSignup} className="space-y-4 sm:space-y-5">
            ...
            {/* Email */}
            <div className="animate-slide-down" style={{ animationDelay: mode === "signup" ? "0.05s" : "0s" }}>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                Email Address
              </label>
              <div className="relative">
            ...
            {/* Password */}
            <div className="animate-slide-down" style={{ animationDelay: mode === "signup" ? "0.1s" : "0.05s" }}>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                Password
              </label>
              <div className="relative">
