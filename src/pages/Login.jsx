...
import { auth, googleProvider } from "../../firebase"; // Ensure the export name matches your firebase.js
...
const Login = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-black p-4">
      {/* Container follows the 'rounded-xl shadow' style from your ProjectTable */}
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl p-8 text-center">
        ...
        {/* Button follows your 'bg-white text-black' style but with better padding & hover */}
        <button
          onClick={handleLogin}
